    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div className="flex-grow flex flex-col justify-center items-center text-center" style={{ zIndex: 1 }}>
                ...
                <button
                    onClick={handleLogin}
                    className="mt-8 px-8 py-3 font-bold text-[var(--deep-space)] bg-[var(--neon-green)] rounded-md hover:bg-[var(--neon-green-alt)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[var(--deep-space)] focus:ring-[var(--neon-green)] transition-all"
                >
                    Fazer Login
                </button>
            </div>
